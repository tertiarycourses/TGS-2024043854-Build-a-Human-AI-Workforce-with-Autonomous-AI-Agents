...
prodoc.add_version_control(doc,[
 ...
 ("1.1",C.VERSION_DATE,"Revised to a 2-day plan (Day 1: Topics 1 & 2; Day 2: Topic 3 & final assessment). Hermes expanded to 14 labs, OpenClaw to 12, Paperclip to 8 (34 labs total). Learning outcomes aligned to the Course Proposal / TSC; per-lab reference videos added.",C.TRAINER),
])
prodoc.add_toc(doc)
