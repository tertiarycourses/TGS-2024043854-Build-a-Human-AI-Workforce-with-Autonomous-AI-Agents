...
prodoc.add_version_control(doc,[
 ...
 ("1.2","14 July 2026","Per-lab step numbering; YouTube links removed (videos remain in the labs); Hermes install lab expanded with the official install methods.",C.TRAINER),
 ...
 ("1.7",C.VERSION_DATE,"Sixty-eight content slides migrated from the original 'Mastering OpenClaw' masterclass deck into Topic 2 as framed figures in their matching labs — agent evolution and Agent = Model + Harness, the OpenClaw Wikipedia history and OpenAI acquisition, deployment options and services, model stacks and Mission Control, channels, skills and ClawHub risks, tools (AgentMail, Agent Browser, Firecrawl), system prompt / workspace / context and memory, security lockdown, slash commands, crons, and use cases (NFT certificates, dashboard, cost saving, Google integration).",C.TRAINER),
])
prodoc.add_toc(doc)
