...
prodoc.add_version_control(doc,[
 ...
 ("1.3",C.VERSION_DATE,"Deck restyled in the dark masterclass theme end-to-end; added the Hermes masterclass slides (What is Hermes; The Bet: Compounding Value; platform matrix; Top-10 slash commands; Telegram setup; memory L1-vs-L2 and session-search; what-is-a-tool, built-in tool catalog and tools-in-action) and the live Achievements dashboard screenshot.",C.TRAINER),
])
prodoc.add_toc(doc)
